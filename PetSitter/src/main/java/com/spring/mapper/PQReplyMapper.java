...
import com.spring.petsitter.board.PQReplyVO;
import com.spring.petsitter.board.mboard.MReplyVO;

public interface PQReplyMapper {
	public int replyCount() throws Exception;
	public List<PQReplyVO> readReply(int bno) throws Exception; // ��� �б�
	public int writeReply(PQReplyVO vo) throws Exception;  // ��� �ۼ�
