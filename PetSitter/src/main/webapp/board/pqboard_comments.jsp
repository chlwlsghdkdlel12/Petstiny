	 ...
	 $.ajax({
		...
		success : function(data) {
		    ...
		    a +='<div class="col-md-10">';	
				...
				a += '<input type="hidden" name="BNO" value="' + <%=pqboard.getPETSITTER_QNA_BNO()%> + '">';
...
function replyInsert(insertData) {
	$.ajax({		
		url : '/petsitter/write_pqReply.bo',
		type : 'POST',
		data : insertData,
		contentType : 'application/x-www-form-urlencoded; charset=UTF-8',
		success : function(data) {
...
function replyUpdate(rno) {
	...
	$.ajax({
		url : '/petsitter/update_pqReply.bo',
		type : 'post',
		dataType : 'json',
...
function replyDelete(rno) {
	$.ajax({
		url : '/petsitter/delete_pqReply.bo?rno=' + rno,
		type : 'post',
	    data : {'rno': rno},
        dataType : 'json',
		contentType : 'application/x-www-form-urlencoded; charset=UTF-8',
