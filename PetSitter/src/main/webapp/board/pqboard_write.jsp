...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="row">
   		<div class="col-md-12">
  			...
  			<div class="input-group">  		
 					<input name="PETSITTER_QNA_SUBJECT" type="text" class="form-control" aria-describedby="sizing-addon1">
				</div>
   		</div>
    </div>
    ...
    <div class="row">
    	<div class="col-md-12">
    		<textarea name = "PETSITTER_QNA_CONTENT"></textarea>
					<script>CKEDITOR.replace('PETSITTER_QNA_CONTENT');</script>
    		</div>
    </div>
