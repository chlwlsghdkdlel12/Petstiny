...
<section class="container">
		    ...
		    <article class="half">
			        ...
			        <div class="content">
				            <div class="idfind1-cont cont">
						             <input type="text" name="email" id="PETSITTER_NAME1" class="inpt" required="required" placeholder="이름을 입력하세요">
						             <input type="text" name="password" id="PETSITTER_TEL1" class="inpt" required="required" placeholder="전화번호를 입력하세요">
						             <input type="email" id="PETSITTER_EMAIL1" class = "inpt" required="required" placeholder = "이메일을 입력하세요">
					<div class="tabs">
				...
				<input type = "text" class = "inpt" id = "idCheck" value = "" readonly>
					<div class="tabs">
				    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span class="tab idfind1"><a href="#idfind1">돌아가기</a></span>
				    </div>
				    </div>
    			<div class="pwfind1-cont cont" style = "display : none;">
                <input type="text" name="PETSITTER_ID" id="PETSITTER_ID2" class="inpt" required="required" placeholder="아이디를 입력하세요">
				<input type="text" name="PETSITTER_NAME" id="PETSITTER_NAME2" class="inpt" required="required" placeholder="이름을 입력하세요">
				<input type="text" name="PETSITTER_TEL" id="PETSITTER_TEL2" class="inpt" required="required" placeholder="전화번호를 입력하세요">
				<input type="email" name="PETSITTER_EMAIL" id="PETSITTER_EMAIL2" class = "inpt" required="required" placeholder = "이메일을 입력하세요">
				<div class="tabs">
            ...
            <input type = "text" class = "inpt" id="pwCheck" value = "" readonly>
            ...
            <div class = "pwfind3-cont cont" style = "display :none;">
            	<form action = "petsitterPwUpdate.me" method = "post">
            		<input type = "hidden" id = "PETSITTER_ID" name = "PETSITTER_ID">
            		<input type = "password" id= "PETSITTER_PW1" name = "PETSITTER_PW" class= "inpt PW1check" placeholder = "새 비밀번호를 입력하세요">
            		<input type = "password" id= "PETSITTER_PW2" class = "inpt PW2check" placeholder = "새 비밀번호 확인">
            		<div class="submit-wrap">
            		<input type="submit" id = "petsitter_submit" value="Change Password" class="submit" style = "display : none;">
           			</div>
            	</form>
            </div>
            </div>
...
$('.tabs .tab').click(function(){
    ...
    if ($(this).hasClass('idfind2')) {
    	var PETSITTER_NAME = $('#PETSITTER_NAME1').val();
    	var PETSITTER_TEL = $('#PETSITTER_TEL1').val();
    	var PETSITTER_EMAIL = $('#PETSITTER_EMAIL1').val();
    	$.ajax({
            url:'/petsitter/petsitterIdFind.bo',
            type:'POST',
            dataType : "text", // 서버에서 보내줄 데이터 타입
            data:{"PETSITTER_NAME":PETSITTER_NAME, "PETSITTER_TEL":PETSITTER_TEL, "PETSITTER_EMAIL":PETSITTER_EMAIL},
    ...
    if ($(this).hasClass('pwfind2')) {
    	var PETSITTER_ID = $('#PETSITTER_ID2').val();
    	var PETSITTER_TEL = $('#PETSITTER_TEL2').val();
    	var PETSITTER_NAME = $('#PETSITTER_NAME2').val();
    	var PETSITTER_EMAIL = $('#PETSITTER_EMAIL2').val();
    	$.ajax({
            url:'/petsitter/petsitterPwFind.bo',
            type:'POST',
            dataType : "text", // 서버에서 보내줄 데이터 타입
            data:{"PETSITTER_ID":PETSITTER_ID, "PETSITTER_TEL":PETSITTER_TEL, "PETSITTER_NAME" : PETSITTER_NAME,"PETSITTER_EMAIL":PETSITTER_EMAIL},
            contentType : 'application/x-www-form-urlencoded; charset=utf-8',
            success:function(data){
            	if(data == "N"){
